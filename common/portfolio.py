...
def build_log_rows(
    ...
    for res in group_results:
        row = {
            ...
            "im_before_realloc": res.get("im_before_realloc", ""),
            "im_after_realloc": res.get("im_after_realloc", ""),
            "realloc_trades_moved": res.get("realloc_trades_moved", ""),
            "realloc_im_reduction": res.get("realloc_im_reduction", ""),
            "realloc_im_reduction_pct": res.get("realloc_im_reduction_pct", ""),
    ...
    agg_row = {
        ...
        "im_before_realloc": totals.get("im_before_realloc", ""),
        "im_after_realloc": totals.get("im_after_realloc", ""),
        "realloc_trades_moved": totals.get("realloc_trades_moved", ""),
        "realloc_im_reduction": totals.get("realloc_im_reduction", ""),
        "realloc_im_reduction_pct": totals.get("realloc_im_reduction_pct", ""),
